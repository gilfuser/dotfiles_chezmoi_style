...
map({ 'n', 'i', 'v' }, "<leader>/", "<ESC>:,$s/", { noremap = true, silent = true, desc = 'find and substitute' })
map({ 'n', 'i', 'v' }, "<leader>(", "<Esc>:s/", { noremap = true, silent = true, desc = 'subsitute faster Linewise' })
-- Select word faster
map({ 'n', 'i' }, "<leader>w", "<Esc>viw", { noremap = true, silent = true, desc = 'select word' })
map("v", "<leader>w", "iw", { noremap = true, silent = true, desc = 'select word' })
map("n", "<leader>W", "viW", { noremap = true, silent = true, desc = 'select word(s) between spaces' })
map("v", "<leader>W", "iW", { noremap = true, silent = true, desc = 'select word(s) between spaces' })
-- ... and change it
map("n", "<leader>c", '"_ciw', { noremap = true, silent = true, desc = 'change word' })
-- to select in between "" c <> {} ()
map({ 'n', 'i' }, "<leader>'", "<Esc>vi'", { noremap = true, silent = true, desc = 'select between single quotes' })
map("n", "<localleader>'", "va'", { noremap = true, silent = true, desc = 'select all including single quotes' })
map({ 'n', 'i' }, '<leader>"', '<Esc>vi"', { noremap = true, silent = true, desc = 'select between double quotes' })
map({ 'n', 'i' }, "<leader>{", "<Esc>vi{", { noremap = true, silent = true, desc = 'select between curly brackets' })
map("n", "<localleader>{", "va{", { noremap = true, silent = true, desc = 'select including curly brackets' })
map({ 'n', 'i' }, "<leader>[", "<Esc>vi[", { noremap = true, silent = true, desc = 'select between brackets' })
map("n", "<localleader>[", "va[", { noremap = true, silent = true, desc = 'select including brackets' })
map({ 'n', 'i' }, "<leader>(", "<Esc>vi(", { noremap = true, silent = true, desc = 'select between parenthesis' })
map("n", "<localleader>(", "va(", { noremap = true, silent = true, desc = 'select including parenthesis' })
map({ 'n', 'i' }, "<leader><", "<Esc>vi<",
    { noremap = true, silent = true, desc = 'select between less-then greater-then' })
...
map({ 'n', 'i' }, '<localleader>"', '<Esc>va"c',
    { noremap = true, silent = true, desc = 'change including double quotes' })
map({ 'n', 'i' }, "<A-0>", '<Esc>"_ci{', { noremap = true, silent = true, desc = 'change inside curly brackets' })
map({ 'n', 'i' }, "<leader><A-0>", '<Esc>"_ca{',
    { noremap = true, silent = true, desc = 'change including curly brackets' })
map({ 'n', 'i' }, "<A-9>", '<Esc>"_ci[', { noremap = true, silent = true, desc = 'change inside brackets' })
map({ 'n', 'i' }, "<leader><A-9>", '<Esc>"_ca[', { noremap = true, silent = true, desc = 'change including brackets' })
...
map({ 'n', 'i' }, "<leader><A-<>", '<Esc>"_ca>c',
    { noremap = true, silent = true, desc = 'change including less-greater-then' })
...
vim.keymap.set("n", "<leader>s", ":%s/\\<<C-r><C-w>\\>/<C-r><C-w>/gI<Left><Left><Left>", { desc = 'replace all occurences of the word you are on' })
